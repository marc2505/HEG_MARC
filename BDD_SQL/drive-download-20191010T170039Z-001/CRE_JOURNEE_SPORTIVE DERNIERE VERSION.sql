...
REM_PRO_ID_PROFESSEUR NUMBER(5)
...
PAR_EMPLACEMENT VARCHAR2(50),
PAR_FRAIS_INSCRIPTION NUMBER(3),
PAR_HEURE_RDV VARCHAR2(5),
PAR_PRIX VARCHAR2(50),
PAR_DUREE_CONFRONTATION NUMBER(2)
  CONSTRAINT CK_PAR_DUREE_CONF CHECK(PAR_DUREE_CONFRONTATION = 10),  --RG07
PAR_HEURE_DEBUT_TOURNOI VARCHAR2(5),
PAR_HEURE_FIN_TOURNOI VARCHAR2(5),
PAR_HEURE_RDV_ORGANISATEUR VARCHAR2(5),
PAR_TEMPS_PAUSE_MIDI NUMBER(1)
...
EQU_ID_PERSONNE NUMBER(5)
  CONSTRAINT NN_EQU_ID_PERSONNE NOT NULL,
PER_NOM VARCHAR2(30)
  CONSTRAINT NN_PER_NOM NOT NULL,
PER_PRENOM VARCHAR2(30)
  CONSTRAINT NN_PER_PRENOM NOT NULL,
PER_DATE_DE_NAISSANCE VARCHAR2(10),
PER_EMAIL VARCHAR2(30),
PER_TELEPHONE NUMBER(10),
PER_ADRESSE VARCHAR2(30),
PER_NPA NUMBER(4),
PER_LOCALITE VARCHAR2(30),
